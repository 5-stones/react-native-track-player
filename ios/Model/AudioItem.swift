...
/// Make your `AudioItem`-subclass conform to this protocol to control which
/// AVAudioTimePitchAlgorithm is used for each
/// item.
public protocol TimePitching {
  func getPitchAlgorithmType() -> AVAudioTimePitchAlgorithm
}

/// Make your `AudioItem`-subclass conform to this protocol to control enable the ability to start
...
/// Make your `AudioItem`-subclass conform to this protocol to set initialization options for the
/// asset. Available keys
/// available at [Apple Developer
/// Documentation](https://developer.apple.com/documentation/avfoundation/avurlasset/initialization_options).
