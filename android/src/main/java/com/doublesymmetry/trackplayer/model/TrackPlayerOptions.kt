    ...
    companion object {
        fun fromBridge(map: ReadableMap?): AudioPlayerOptionsData {
            ...
            return AudioPlayerOptionsData(
                ...
                androidOptions = if (map.hasKey("android")) AndroidAudioPlayerOptions.fromBridge(map.getMap("android")) else null,
                ...
                wakeMode = if (map.hasKey("wakeMode")) {
                    ...
                    PlayerWakeMode.entries.getOrNull(value)
                        ?: throw IllegalArgumentException("Invalid wakeMode value: $value (valid range: 0-${PlayerWakeMode.entries.size - 1})")
